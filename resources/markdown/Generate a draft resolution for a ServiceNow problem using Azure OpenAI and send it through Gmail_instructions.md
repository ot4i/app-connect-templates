...
3. Click the **Servicenow** node, and if you're not already connected, connect to your [Servicenow account](https://www.ibm.com/docs/en/app-connect/saas?topic=apps-servicenow).
4. Click the **Gmail** node, and if you're not already connected, connect to your [Gmail account](https://www.ibm.com/docs/en/app-connect/saas?topic=apps-gmail).
5. To start the flow, in the banner, click **Start flow**.

Use this template to automate the process of Customer service assistant with a draft resolution for the issue being sent to the user. 