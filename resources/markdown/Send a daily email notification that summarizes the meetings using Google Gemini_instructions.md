...
1. Connect to [Google Drive](https://www.ibm.com/docs/en/app-connect/cd?topic=apps-google-drive).
1. On the Google Drive "Retrieve folder items" node, provide the __folder id__ for the __parent folder__ where you store your meeting transcripts daily.
...
1. On the Email "Send email" node, provide your __email__ in __To__ field
1. Click **Done**.
