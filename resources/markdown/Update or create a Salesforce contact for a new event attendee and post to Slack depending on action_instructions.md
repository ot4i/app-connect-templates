...
1. Click the Salesforce node, then connect to your Salesforce  account (more info here)[https://developer.ibm.com/integration/docs/app-connect/how-to-guides-for-apps/use-ibm-app-connect-salesforce/]. 
1. Check the information that will be copied from Eventbrite.  You might want to add more information. 
1. Click one of the Slack nodes, then connect to your Slack account (more info here)[https://developer.ibm.com/integration/docs/app-connect/how-to-guides-for-apps/use-ibm-app-connect-slack/]. 
